...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class JunitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v110</b> with <b>androidx.test.ext:junit</b> coordinates and
         * with version reference <b>androidxJunit</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV110() {
            return create("junit.v110");
        }
    ...
    public static class LifecycleLivedataKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public Provider<MinimalExternalModuleDependency> getV270() {
            return create("lifecycle.livedata.ktx.v270");
        }

    }

    public static class LifecycleViewmodelLibraryAccessors extends SubDependencyFactory {
        private final LifecycleViewmodelKtxLibraryAccessors laccForLifecycleViewmodelKtxLibraryAccessors = new LifecycleViewmodelKtxLibraryAccessors(owner);

        public LifecycleViewmodelLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>lifecycle.viewmodel.ktx</b>
         */
        public LifecycleViewmodelKtxLibraryAccessors getKtx() {
            return laccForLifecycleViewmodelKtxLibraryAccessors;
        }

    }

    public static class LifecycleViewmodelKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public LifecycleViewmodelKtxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getV270() {
            return create("lifecycle.viewmodel.ktx.v270");
        }
    ...
    public static class OrgProjectlombokLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>projectlombokLombok</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class ScarletLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final ScarletLifecycleLibraryAccessors laccForScarletLifecycleLibraryAccessors = new ScarletLifecycleLibraryAccessors(owner);
        private final ScarletMessageLibraryAccessors laccForScarletMessageLibraryAccessors = new ScarletMessageLibraryAccessors(owner);
        private final ScarletStreamLibraryAccessors laccForScarletStreamLibraryAccessors = new ScarletStreamLibraryAccessors(owner);
        private final ScarletWebsocketLibraryAccessors laccForScarletWebsocketLibraryAccessors = new ScarletWebsocketLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>scarlet.lifecycle</b>
         */
        public ScarletLifecycleLibraryAccessors getLifecycle() {
            return laccForScarletLifecycleLibraryAccessors;
        }

        /**
         * Group of libraries at <b>scarlet.message</b>
         */
        public ScarletMessageLibraryAccessors getMessage() {
            return laccForScarletMessageLibraryAccessors;
        }

        /**
         * Group of libraries at <b>scarlet.stream</b>
         */
        public ScarletStreamLibraryAccessors getStream() {
            return laccForScarletStreamLibraryAccessors;
        }

        /**
         * Group of libraries at <b>scarlet.websocket</b>
         */
        public ScarletWebsocketLibraryAccessors getWebsocket() {
            return laccForScarletWebsocketLibraryAccessors;
        }

    }

    public static class ScarletLifecycleLibraryAccessors extends SubDependencyFactory {

        public ScarletLifecycleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.tinder.scarlet:scarlet-lifecycle-android</b> coordinates and
         * with version reference <b>scarlet</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("scarlet.lifecycle.android");
        }

    }

    public static class ScarletMessageLibraryAccessors extends SubDependencyFactory {
        private final ScarletMessageAdapterLibraryAccessors laccForScarletMessageAdapterLibraryAccessors = new ScarletMessageAdapterLibraryAccessors(owner);

        public ScarletMessageLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>scarlet.message.adapter</b>
         */
        public ScarletMessageAdapterLibraryAccessors getAdapter() {
            return laccForScarletMessageAdapterLibraryAccessors;
        }

    }

    public static class ScarletMessageAdapterLibraryAccessors extends SubDependencyFactory {

        public ScarletMessageAdapterLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>gson</b> with <b>com.tinder.scarlet:scarlet-message-adapter-gson</b> coordinates and
         * with version reference <b>scarlet</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getGson() {
            return create("scarlet.message.adapter.gson");
        }

    }

    public static class ScarletStreamLibraryAccessors extends SubDependencyFactory {
        private final ScarletStreamAdapterLibraryAccessors laccForScarletStreamAdapterLibraryAccessors = new ScarletStreamAdapterLibraryAccessors(owner);

        public ScarletStreamLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>scarlet.stream.adapter</b>
         */
        public ScarletStreamAdapterLibraryAccessors getAdapter() {
            return laccForScarletStreamAdapterLibraryAccessors;
        }

    }

    public static class ScarletStreamAdapterLibraryAccessors extends SubDependencyFactory {

        public ScarletStreamAdapterLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>rxjava2</b> with <b>com.tinder.scarlet:scarlet-stream-adapter-rxjava2</b> coordinates and
         * with version reference <b>scarlet</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRxjava2() {
            return create("scarlet.stream.adapter.rxjava2");
        }

    }

    public static class ScarletWebsocketLibraryAccessors extends SubDependencyFactory {

        public ScarletWebsocketLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>okhttp</b> with <b>com.tinder.scarlet:scarlet-websocket-okhttp</b> coordinates and
         * with version reference <b>scarlet</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getOkhttp() {
            return create("scarlet.websocket.okhttp");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxJunit</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationRuntime</b> with value <b>2.7.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>projectlombokLombok</b> with value <b>1.18.32</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getProjectlombokLombok() { return getVersion("projectlombokLombok"); }
