...
public class FaveCourseListRecyclerViewAdapter extends RecyclerView.Adapter<FaveCourseListRecyclerViewAdapter.ViewHolder> {

    private final Context context;
    private final List<CourseGson> courseGsonList;
    private final FaveCourseListRecyclerViewAdapter.OnItemClickListener onItemClickListener;
    private MainFacade mainFacade;
    private ImageLoader imageLoader;

    public FaveCourseListRecyclerViewAdapter(Context context, List<CourseGson> courseGsonList, OnItemClickListener onItemClickListener, MainFacade mainFacade) {
    ...
    @NonNull
    @Override
    public FaveCourseListRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_fave_course_list, parent, false);
        return new FaveCourseListRecyclerViewAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FaveCourseListRecyclerViewAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final ImageButton btnFave;
        public ViewHolder(@NonNull View itemView) {
            ...
            btnFave = itemView.findViewById(R.id.course_list_btn_favorite);
